...
const rollupConfig = () => {
    ...
    return [
        ...
        createConfig('Left', 'left'),
        createConfig('Right', 'right') ,
        createConfig('LeftComhem', 'leftComhem'),
        createConfig('RightComhem', 'rightComhem'),
        createConfig('YetAnother', 'yetAnother')
    ]
}
